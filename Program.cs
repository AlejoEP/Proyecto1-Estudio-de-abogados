...
namespace AbogadosExpedientes
{
    internal class Program
    {
        ...
        {
            EstudioJuridico alejo;
            alejo = new EstudioJuridico();
            ...
            while (num != 0)
            {
                ...
                {
                    Console.WriteLine("Para borrar un contacto ingrese su dni: ");
                    string dni = Console.ReadLine();
                    alejo.eliminarAbogado(dni);
                    menu();
                    Console.WriteLine("Elija una opcion: ");
                    num = int.Parse(Console.ReadLine());
                }                
    ...
    class EstudioJuridico
    {
        ...
        public void mostrar()
        {
            ...
            {
                Console.WriteLine($"{xabogado.Nombre} {xabogado.Apellido}");
            }
        }
        public void eliminarAbogado(string documento)
        {
            ArrayList nueva_lista_abogados = new ArrayList();
            foreach (Abogado xabogado in lista_abogados)
            {
                if (xabogado.Dni != documento)
                {
                    nueva_lista_abogados.Add(xabogado);
                }
            }
            
            lista_abogados = nueva_lista_abogados;
        }
    }
    class Expediente
    {
